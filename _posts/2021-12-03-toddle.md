...
Toddle is an AI agent that takes notes for the learner, extracting key points, sharing notes with other learners. This project utilized AWS and ML tools for speech-to-text conversion and summarization of the text. The project was a team project by Minjung, Sahana, Audite, Kamile from the Breakthrough AI program and advised by the company adivsor Shanika and Josh from Google. 
